  ...
  return (
    <div className="space-y-10">
      <div className="bg-white p-10 shadow-md border border-slate-200">
        <h2 className="text-3xl font-bold text-emerald-800 mb-4 underline">Niveles Clave</h2>
        ...
        {step === 2 && (
          <div>
            ...
            <h3 className="text-3xl font-bold text-emerald-800 mb-6 text-center underline">Resultados del Diagnóstico</h3>
